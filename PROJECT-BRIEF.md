...
NOTE items_cataloged :: c3 is 10 confirmed in one 2h45m sitting on 07-28 and has fired no event since. She corrected nothing — was_fixed false on all 19 confirms :: 2026-08-02
NOTE items_cataloged :: c4 is 0 captured / 0 confirmed and has no display name set, so friends_with_counts fails her closed and she is invisible in friend lists by design. Two visits, both under 20 seconds, both ending at the onboarding welcome step :: 2026-08-02
NOTE items_cataloged :: c5 is 26 confirmed in a single day and is the most active real account. She returned on a third day, 08-01, and logged 2 wear events five seconds after a daily fit — the first return-and-use in the beta. She made 52 tag corrections, the most in the cohort. Her first six camera captures all failed background removal silently and never got a cutout :: 2026-08-02
NOTE items_cataloged :: c6 is 0 captured / 0 confirmed. One day of use ever, 12 events, 1m16s total time in product, nothing since 07-30. She is half the only cohort-to-cohort friendship edge, so Gate C cannot close without her :: 2026-08-02
NOTE items_cataloged :: every cohort member who catalogued anything did it on exactly one unbroken sitting, and nobody has ever catalogued on a second calendar day. But FOUR of six did return on a later day — they returned without cataloguing. And that sitting is not necessarily the first: c1 signed in 07-28 and took her first photo on 08-01, four days later :: 2026-08-02
...
NOTE items_cataloged :: 13 item_shares and 6 lendable items now exist, all created by Tate on 2026-08-01 as a deliberate nudge — 3 to c5, 4 to c3, 3 to c2, plus 3 from a demo account. They are real rows and they will appear the moment a build carrying 18b/19 reaches the cohort :: 2026-08-02
...
NOTE current_build :: SETTLED 2026-08-02 by Tate against App Store Connect — build 14 is on ALL SIX cohort phones, not just Tate's. It is the first build ever to carry sharing, lendable and the borrow loop. Every repo-side inference to the contrary (docs/status/2026-08-01.md, docs/build-riders.md, the commit record showing no approval) reasoned from ABSENCE OF DATA and was wrong; no event carries app version, so telemetry could never have settled it and direct observation is the only authority here :: 2026-08-02
NOTE gate_c_build :: CORRECTED — every lendable item belongs to Tate (6) or to Ada, the App Review seed (2). ZERO are owned by a cohort member, and the 13 shares are Tate's outbound nudge. Under Tate's own founder exclusion a borrow he is party to does not close the gate, so gate C is arithmetically impossible today regardless of build state :: 2026-08-02
NOTE gate_c_build :: with build 14 confirmed on all six phones, the zero is now BEHAVIOURAL and readable. No cohort member has ever fired friend_closet_opened, item_shared or lendable_set — all 16, 13 and 8 belong to Tate — and four of the six could have. c1 had 3 shared pieces land 9 minutes before she stopped a 32-minute session; c5 opened the app for 17 seconds with 3 pieces waiting and went to Today's Fit instead. Availability is not adoption, and this is the first metric in the product's life that separates she-does-not-want-to from she-never-looked :: 2026-08-02
NOTE gate_c_build :: build 13 was cut from an off-main staged commit that reverted 18b and 19 thirty-two seconds before the build started. Main carries both in full; no build ever has :: 2026-08-02
...
OPEN cohort_confirm_stall :: eng :: the capture-to-closet seam is real but c2 is no longer evidence for it — her six were admitted by server-side SQL, not by her, and her four-day gap was a 2.5-hour pipeline outage that drained 58 minutes after she put the phone down. The standing evidence is c1's own words: capture to closet takes two screens and she called it unintuitive. Auto-admit shipped 2026-08-01 to close the seam; nobody has catalogued since, so it is untested on a live capture
OPEN feedback_pipe_empty :: eng :: the door is NOT broken — the edge function is deployed and was verified end to end. Build 12, which first carried it, was canceled, so it only became installable with build 13 on 07-29; c1 signed up on build 11 and cannot have used this door. c2 and c3 have not opened the You tab since it shipped. Realistic lost submissions: zero, upper bound one. The real defect is that track() fires only on success, so an attempt is invisible
